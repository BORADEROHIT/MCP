...
async def run():
    ...
    config_file = "configs/advanced_tool_server.json"
    ...
    for server_name in server_names:
        ...
        for t in tools:
            ...
            #print('Tool Input Schema:',t.inputSchema)
            #print('Tool Output Schema:',t.outputSchema)
            #print('Tool Annotations:',t.annotations)
            print('-'*20)
        print('='*30)
    try:
            # Main chat loop
